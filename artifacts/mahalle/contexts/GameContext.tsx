      ...
      .then(([n, vib, mute, bgEnabled, bgVolume, toasts, ka]) => {
        ...
        if (bgVolume == null) {
          ...
          if (Number.isFinite(parsedVolume)) {
            const normalized = parsedVolume > BG_MUSIC_MAX_VOLUME ? BG_MUSIC_DEFAULT_VOLUME : parsedVolume;
            const clamped = Math.max(0, Math.min(BG_MUSIC_MAX_VOLUME, normalized));
